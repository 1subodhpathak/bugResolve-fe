        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
            ...
            <div className="inline-flex items-center space-x-2 bg-green-50 border border-green-200 rounded-full px-4 py-2">
              ...
              <span className="text-green-700 text-sm font-semibold">AI-Powered Bug Resolution</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-2xl mx-auto">
              Connect your repositories, let AI analyze and solve issues automatically. 
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <Link to="/auth" className="btn btn-primary text-lg px-8 py-4 shadow-xl hover:shadow-2xl">
                <Github size={24} />
                <span>Start Solving Issues</span>
                <ArrowRight size={20} />
              </Link>
            ...
            {/* Social Proof */}
            <div className="flex items-center justify-center space-x-8 pt-8 text-gray-600">
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="font-semibold">10K+ Issues Solved</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900">
                  Why Developers Love Bug Resolve
                </h2>
      ...
      <section className="section bg-gradient-to-br from-green-600 to-blue-600 text-white">
        <div className="container-custom text-center space-y-8">
          ...
          <p className="text-xl md:text-2xl opacity-90 max-w-2xl mx-auto">
            Join Bug Resolve today and let AI handle the debugging while you focus on building amazing products.
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-400 text-sm">
                AI-powered bug resolution for modern developers
              </p>
            </div>
